...
export default function SearchBox() {
  return (
    <div className="flex items-center bg-[#ececec] focus-within:bg-[#333] text-gray-500 focus-within:text-[#bebebe] transition-all duration-[350ms] rounded-lg px-4 group absolute min-w-[500px] max-w-[750px] left-1/2 -translate-x-1/2">
